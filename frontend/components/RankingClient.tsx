  ...
  return (
    <div className="space-y-4 rounded-2xl border border-line bg-panel p-5">
      <div>
        ...
        {error && <p className="mb-2 rounded-lg border border-accent/40 bg-accent/10 px-3 py-2 text-sm text-accent">{error}</p>}
        {!isAuthed ? (
          ...
          <div className="flex gap-2">
            <select
              ...
              className="flex-1 rounded-lg border border-line bg-panel2 px-3 py-2 text-ink outline-none"
            >
