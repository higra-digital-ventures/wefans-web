...
export default async function AdminDashboard() {
  ...
  return (
    <main>
      ...
      <div className="mb-8 flex flex-wrap items-center gap-3 rounded-2xl border border-line bg-panel p-4">
        ...
        {metrics.reviewPending > 0 && (
          <Link href="/admin/fraude" className="rounded-lg border border-amber-500/40 px-3 py-1.5 text-xs text-amber-300">
